...
simple_doses <- read_csv("../results_tables/simple_model_doses_results_final_unstandardised.csv")
stab_doses <- read_csv("../results_tables/stability_model_doses_results_final_unstandardised.csv")
step_doses <- read_csv("../results_tables/stepwise_model_doses_results_final_unstandardised.csv")

simple_dropout <- read_csv("../results_tables/simple_between_doses_final_unstandardised.csv")
stab_dropout <- read_csv("../results_tables/stability_between_doses_final_unstandardised.csv")
step_dropout <- read_csv("../results_tables/stepwise_between_doses_final_unstandardised.csv")
...
write.csv(doses, "../results_tables/model_results_doses_unstandardised.csv")


dropout <- rbind(simple_dropout, stab_dropout, step_dropout)
write.csv(dropout, "../results_tables/model_results_dropout_unstandardised.csv")
...
ggsave("../figures/png/doses_forest_unstandardised.png", plot = plot1n2n3, width = 12, height = 15)
ggsave("../figures/tiff/doses_forest_unstandardised.tiff", plot = plot1n2n3, width = 12, height = 15)



# Load the PNG file
img <- png::readPNG("../figures/png/doses_forest_unstandardised.png")
pdf("../figures/pdf/doses_forest_unstandardised.pdf", width = 8, height = 6)  
grid.raster(img)
dev.off()
...
ggsave("../figures/png/dropout_forest_unstandardised.png", plot = plot4n5, width = 13, height = 10)
ggsave("../figures/tiff/dropout_forest_unstandardised.tiff", plot = plot4n5, width = 13, height = 10)


# Load the PNG file
img2 <- png::readPNG("../figures/png/dropout_forest_unstandardised.png")
pdf("../figures/pdf/dropout_forest_unstandardised.pdf", width = 8, height = 6)  
grid.raster(img2)
dev.off()
