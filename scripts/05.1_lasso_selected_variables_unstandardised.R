...
print(paste0("lambda: ", hat_params_fd[1])) # lambda: 3.18669398018553"
print(paste0("pi: ", hat_params_fd[2])) # "pi: 0.83"
...
print(paste0("pi: ", hat_params_sd[2])) # pi: 0.56
...
print(paste0("lambda: ", hat_params_td[1])) # lambda:  0.515535007800333"
print(paste0("pi: ", hat_params_td[2])) # pi: 0.59
...
print(paste0("lambda: ", hat_params_1v2[1])) # lambda: 0.435337368518439
print(paste0("pi: ", hat_params_1v2[2])) # pi: 0.60
...
print(paste0("lambda: ", hat_params_2v3[1])) # lambda: 0.692769875652554
...
write.csv(lasso_models, "../results_tables/stability_model_doses_results_final_unstandardised.csv")
...
write.csv(lasso_models, "../results_tables/stability_between_doses_final_unstandardised.csv")
