...
write.csv(simple_models, "../results_tables/simple_model_doses_results_final_unstandardised.csv")
...
simple_models <- rbind(simple_fixed,simple_random)
write.csv(simple_models, "../results_tables/simple_between_doses_final_unstandardised.csv")
